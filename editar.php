<?php
include_once'bd.php';
$gsent = $pdo->prepare('SELECT * FROM `productos` WHERE `id`= 3');
$gsent->execute();
...
<form action="./subir.php" method="POST" enctype="multipart/form-data">
        ...
        <select required name="categoria" class="form-control form-control-sm" value="<?php echo $producto[0]['categoria']?>">
